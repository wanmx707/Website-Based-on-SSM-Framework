...
public interface MediaService {
     ...
     * @throws Exception
     */
    public boolean saveMedia(Uservideo media)throws Exception;
     ...
     * @return
     */
    public List<Uservideo> queryALlMedia(int firstResult, int maxResult)throws Exception;
     ...
     * @throws Exception
     */
    public Uservideo queryMediaById(int id)throws Exception;
}
