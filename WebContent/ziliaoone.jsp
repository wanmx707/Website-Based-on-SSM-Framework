						...
						<div class="g_bd">
							<div class="dm_crumbs g_crumbs">
								当前位置：<a href="queryindex.action" target='_self'>海贼王分享网</a><span
									...
									href="finddata.action" target='_self'>资料</a>
							</div>
							<div class="dm_acticle">
								<h1 class="dm_title">${opdata.titleopdata }</h1>
								<div class="dm_author">
									<span>作者：海贼王分享网</span><span>来源：网络</span> <span>时间：<fmt:formatDate
											value="${opdata.addtime}" pattern="YYYY-MM-dd" /></span>
								</div>
								<div class="dm_content">${opdata.content }</div>
							</div>
						</div>
						<div class="g_fd">
