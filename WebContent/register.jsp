...
                return false;
            }
            if(/^\w{6,20}$/.test(nameElement.value)){
...
            else{
                nameElement.className="wrong";//获取元素对象的class属性
                msgElement.innerHTML="<span style='color:red'>用户名长度应该在6-20之间!</span>";
                return false;
            }
        }
...
function validateCode() {
	...
	        }
        function validate() {
            return validateName()&&validatePassword()&&validateRePassword()&&validateEmail()&&validateCode();
        }
					...
					<div class="mn">
						...
						<div class="bm" id="main_message">
							...
							<div class="bm_h bbs" id="main_hnav">
								<span class="y"> <a href="login.jsp" class="xi2">已有帐号？现在登录</a>
								</span>
							...
							<form method="post" autocomplete="off" name="register"
								...
								onsubmit="return validate();" action="register.action">
												...
												<table>
													<tr>
														<th><span class="rq">*</span><label
															for="usernamec450442b63f5b3d2">用户名:</label></th>
														<td><input type="text" id="name" name="username"
															onblur="validateName();" class="init"
															value="${user.username }" /></td>
														<td><span id="nameMsg"></span></td>
														<span style="color: red">${usernamewrong }</span>
													</tr>
												</table>
											</div>
