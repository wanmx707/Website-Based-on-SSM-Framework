...
<body>
	<form id="frmDemo" enctype="multipart/form-data" method="post"
				action="<%=basePath%>updateOpdataByid.action" onsubmit="return validate();">
				<br /> <br />
				...
				<br /> <br />
				<div align="center">
				<input type="hidden" name="opdataid" value="${opdata.opdataid }"/>
					标题：<input type="text" id="titleopdata" name="titleopdata" value="${opdata.titleopdata }" style="width: 450px;"/>
				</div>
				<br /> <br />
				<div align="center">
					新封面：<input type="file" id="file" name="file"/>
					<img src="http://localhost:8080/ziliaoimg/${opdata.opdatapic }" alt="" />
				</div>
				<br /> <br />
				<textarea id="content" name="content" rows="25" cols="80" style="width: 100%" >${opdata.content }</textarea>
