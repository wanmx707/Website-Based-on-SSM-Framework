...
<body>
	<form id="frmDemo" enctype="multipart/form-data" method="post"
				action="<%=basePath%>updateInManageforByid.action" onsubmit="return validate();">
				<br /> <br />
				...
				<div align="center">
					标题：<input type="text" id="infortitle" name="infortitle" value="${information.infortitle }" style="width: 450px;"/>
				<input type="hidden" name="inforid" value="${information.inforid }"/>
				</div>
				<br /> <br />
				<textarea id="inforcontent" name="inforcontent" rows="25" cols="80" style="width: 100%" >${information.inforcontent }</textarea>
