...
<body>
	<h1>网站管理&nbsp;&gt;&gt;&nbsp;上传漫画</h1>
	<form action="../../../uploadcomics.action" method="post"
		...
		<table id="tblAddDocument" width="90%" border="1"
			...
			<tr>
				...
				<td><input type="text" name="comicsname" style="width:300px;"/><font
					color="red" size="3px">*标题无法更改请仔细斟酌决定</font></td>
			</tr>
			<tr>
				<td align="right">话数</td>
				<td><input type="text" name="comnumber" style="width:300px;"/><font
					color="red" size="3px"></font></td>
			</tr>
			<tr>
				<td align="right">上传文件</td>
				<td><input type="file" multiple="multiple" name="fileupload" id="fileupload" accept="image/gif,image/jpeg,image/jpg,image/png" /><font
