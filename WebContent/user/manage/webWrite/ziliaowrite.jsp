...
<body>
	<form id="frmDemo" enctype="multipart/form-data" method="post"
				action="<%=basePath%>uploadOpdata.action" onsubmit="return validate();">
				<br /> <br />
				...
				<br /> <br />
				<div align="center">
					标题：<input type="text" id="titleopdata" name="titleopdata" value="${information.infortitle }" style="width: 450px;"/>
				</div>
				<br /> <br />
				<div align="center">
					封面：<input type="file" id="file" name="file" value="${information.infortitle }" style="width: 450px;"/>
				</div>
				<br /> <br />
